...
import { removeOneBlogProfile, setSaveBlogProfile } from "@/hook/redux/features/profileSlice";
...
export default function PostProfile({ data }) {
    ...
    const handleDeleteConfirm = async () => {
        ...
        if (currentBlogIdSelected) {
            ...
            dispatch(removeOneBlogProfile(currentBlogIdSelected))
    ...
    const handleSaveBlog = async () => {
        ...
        if (currentBlogIdSelected) {
            ...
            dispatch(setSaveBlogProfile(currentBlogIdSelected))
