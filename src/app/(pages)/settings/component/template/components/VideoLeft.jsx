export default function VideoLeft({ props, color }) {
    ...
    return (
        <div className="max-w-[800px] my-8 w-full h-full min-h-[300px] flex justify-center items-center relative" >
            <div className="min-h-full w-full bg-gray-200 max-w-[58%] flex justify-center items-end absolute flex-col p-4 right-0 text-right" style={{ backgroundColor: color ? color : '' }}>
                <div className="font-bold text-2xl mb-2 mr-4 ">{props?.title1 ? props.title1 : "TITLE"}</div>
                <div className="text-sm mr-4 ml-16">
            ...
            <div className="mt-4 w-[50%] h-[70%] absolute left-0">
                <iframe
