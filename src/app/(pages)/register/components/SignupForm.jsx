...
export default function SignupForm() {
    ...
    return (
        <div className="max-w-[500px] w-full h-auto flex flex-col justify-center items-center gap-5 mb-20 sm:p-0 p-3">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 w-full">
                ...
                <div className='w-full flex flex-wrap gap-2 text-[#A9A9A9]'>
                    ...
                    <label className='gap-2 flex'>
                        ...
                        <Link href={'/terms.html'} className='underline font-bold'>
                            {t('terms')}
                        </Link>
                        &
                        <Link href={'/privacy-policy.html'} className='underline font-bold'>
                            {t('privatePolicy')}
                        </Link>
                    </label>
